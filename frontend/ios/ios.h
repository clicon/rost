...
int ios_cli_show_archive_diff(clicon_handle h, char *file, struct lvmap *lmap);
int cli_ios_show_running(clicon_handle h, struct lvmap *lmap);
int cli_ios_show_config(clicon_handle h, char *file, struct lvmap *lmap);
