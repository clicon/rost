...
#endif /* notyet */
bgp("BGP specific commands") default("Configure BGP defaults") local-preference("local preference (higher=more preferred)") <number range[0:4294967295]>("Configure default local preference value"), cli_set("router.bgp.default.local-preference $local_preference"), ADMIN;
...
no("Negate a command or set its defaults") bgp("BGP specific commands") default("Configure BGP defaults") local-preference("local preference (higher=more preferred)") <number range[0:4294967295]>("Configure default local preference value"), cli_del("router.bgp.default.local-preference"), ADMIN;
...
/* NEIGHBOR LOCAL-AS */
neighbor("Specify a neighbor router") <neighbor:ipv4addr expand_bgp_neighbor()>("Neighbor address") local-as("Specify a local-as number") <number range[1:4294967295]>("AS number used as local AS"),  cli_set("router.bgp.neighbor[].local-as $!neighbor $localas"), ADMIN;
neighbor("Specify a neighbor router") <neighbor:ipv4addr expand_bgp_neighbor()>("Neighbor address") local-as("Specify a local-as number") <number range[1:4294967295]>("AS number used as local AS") no-prepend("Do not prepend local-as to updates from ebgp peers"), cli_set("router.bgp.neighbor[].local-as $!neighbor $localas $no_prepend=(string)\"no-prepend\""), expand_ADMIN;
...
no("Negate a command or set its defaults") neighbor("Specify a neighbor router") <neighbor:ipv4addr expand_bgp_neighbor()>("Neighbor address") local-as("Specify a local-as number") <number range[1:4294967295]>("AS number used as local AS"), cli_del("router.bgp.neighbor[].local-as $!neighbor"), ADMIN;
no("Negate a command or set its defaults") neighbor("Specify a neighbor router") <neighbor:ipv4addr expand_bgp_neighbor()>("expand_Neighbor address") local-as("Specify a local-as number") <number range[1:4294967295]>("AS number used as local AS") no-prepend("Do not prepend local-as to updates from ebgp peers"), cli_del("router.bgp.neighbor[].local-as $!neighbor"), ADMIN;
...
redistribute("Redistribute information from another routing protocol") connected("Connected routes") metric("Metric for redistributed routes") <number range[0:4294967295]>("Default metric"), cli_set("router.bgp.redistribute.connected $metric"), ADMIN;
redistribute("Redistribute information from another routing protocol") connected("Connected routes") metric("Metric for redistributed routes") <number range[0:4294967295]>("Default metric") route-map("Route map reference") <string>("Pointer to route-map entries"), cli_set("router.bgp.redistribute.connected $metric $route_map"), ADMIN;
...
no("Negate a command or set its defaults") redistribute("Redistribute information from another routing protocol") connected("Connected routes") metric("Metric for redistributed routes") <number range[0:4294967295]>("Default metric"), cli_del("router.bgp.redistribute.connected $metric"), ADMIN;
no("Negate a command or set its defaults") redistribute("Redistribute information from another routing protocol") connected("Connected routes") metric("Metric for redistributed routes") <number range[0:4294967295]>("Default metric") route-map("Route map reference") <string>("Pointer to route-map entries"), cli_del("router.bgp.redistribute.connected $metric $route_map"), ADMIN;
...
redistribute("Redistribute information from another routing protocol") kernel("Kernel routes") metric("Metric for redistributed routes") <number range[0:4294967295]>("Default metric"), cli_set("router.bgp.redistribute.kernel $metric"), ADMIN;
redistribute("Redistribute information from another routing protocol") kernel("Kernel routes") metric("Metric for redistributed routes") <number range[0:4294967295]>("Default metric") route-map("Route map reference") <string>("Pointer to route-map entries"), cli_set("router.bgp.redistribute.kernel $metric $route_map"), ADMIN;
...
redistribute("Redistribute information from another routing protocol") kernel("Kernel routes") route-map("Route map reference") <string>("Pointer to route-map entries") metric("Metric for redistributed routes") <number range[0:4294967295]>("Default metric"), cli_set("router.bgp.redistribute.kernel $route_map $metric"), ADMIN;
...
no("Negate a command or set its defaults") redistribute("Redistribute information from another routing protocol") kernel("Kernel routes") metric("Metric for redistributed routes") <number range[0:4294967295]>("Default metric"), cli_del("router.bgp.redistribute.kernel $metric"), ADMIN;
no("Negate a command or set its defaults") redistribute("Redistribute information from another routing protocol") kernel("Kernel routes") metric("Metric for redistributed routes") <number range[0:4294967295]>("Default metric") route-map("Route map reference") <string>("Pointer to route-map entries"), cli_del("router.bgp.redistribute.kernel $metric $route_map"), ADMIN;
...
redistribute("Redistribute information from another routing protocol") ospf("Open Shurtest Path First (OSPF)") metric("Metric for redistributed routes") <number range[0:4294967295]>("Default metric"), cli_set("router.bgp.redistribute.ospf $metric"), ADMIN;
redistribute("Redistribute information from another routing protocol") ospf("Open Shurtest Path First (OSPF)") metric("Metric for redistributed routes") <number range[0:4294967295]>("Default metric") route-map("Route map reference") <string>("Pointer to route-map entries"), cli_set("router.bgp.redistribute.ospf $metric $route_map"), ADMIN;
...
no("Negate a command or set its defaults") redistribute("Redistribute information from another routing protocol") ospf("Open Shurtest Path First (OSPF)") metric("Metric for redistributed routes") <number range[0:4294967295]>("Default metric"), cli_del("router.bgp.redistribute.ospf $metric"), ADMIN;
no("Negate a command or set its defaults") redistribute("Redistribute information from another routing protocol") ospf("Open Shurtest Path First (OSPF)") metric("Metric for redistributed routes") <number range[0:4294967295]>("Default metric") route-map("Route map reference") <string>("Pointer to route-map entries"), cli_del("router.bgp.redistribute.ospf $metric $route_map"), ADMIN;
...
redistribute("Redistribute information from another routing protocol") rip("Routing Information Protocol (RIP)") metric("Metric for redistributed routes") <number range[0:4294967295]>("Default metric"), cli_set("router.bgp.redistribute.rip $metric"), ADMIN;
redistribute("Redistribute information from another routing protocol") rip("Routing Information Protocol (RIP)") metric("Metric for redistributed routes") <number range[0:4294967295]>("Default metric") route-map("Route map reference") <string>("Pointer to route-map entries"), cli_set("router.bgp.redistribute.rip $metric $route_map"), ADMIN;
...
no("Negate a command or set its defaults") redistribute("Redistribute information from another routing protocol") rip("Routing Information Protocol (RIP)") metric("Metric for redistributed routes") <number range[0:4294967295]>("Default metric"), cli_del("router.bgp.redistribute.rip $metric"), ADMIN;
no("Negate a command or set its defaults") redistribute("Redistribute information from another routing protocol") rip("Routing Information Protocol (RIP)") metric("Metric for redistributed routes") <number range[0:4294967295]>("Default metric") route-map("Route map reference") <string>("Pointer to route-map entries"), cli_del("router.bgp.redistribute.rip $metric $route_map"), ADMIN;
...
redistribute("Redistribute information from another routing protocol") static("Static routes") metric("Metric for redistributed routes") <number range[0:4294967295]>("Default metric"), cli_set("router.bgp.redistribute.static $metric"), ADMIN;
redistribute("Redistribute information from another routing protocol") static("Static routes") metric("Metric for redistributed routes") <number range[0:4294967295]>("Default metric") route-map("Route map reference") <string>("Pointer to route-map entries"), cli_set("router.bgp.redistribute.static $metric $route_map"), ADMIN;
...
redistribute("Redistribute information from another routing protocol") static("Static routes") route-map("Route map reference") <string>("Pointer to route-map entries") metric("Metric for redistributed routes") <number range[0:4294967295]>("Default metric"), cli_set("router.bgp.redistribute.static $route_map $metric"), ADMIN;
...
no("Negate a command or set its defaults") redistribute("Redistribute information from another routing protocol") static("Static routes") metric("Metric for redistributed routes") <number range[0:4294967295]>("Default metric"), cli_del("router.bgp.redistribute.static $metric"), ADMIN;
no("Negate a command or set its defaults") redistribute("Redistribute information from another routing protocol") static("Static routes") metric("Metric for redistributed routes") <number range[0:4294967295]>("Default metric") route-map("Route map reference") <string>("Pointer to route-map entries"), cli_del("router.bgp.redistribute.static $metric $route_map"), ADMIN;
