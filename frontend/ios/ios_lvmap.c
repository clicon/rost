/*
 *  CVS Version: $Id: ios_lvmap.c,v 1.5 2013/01/01 07:42:26 benny Exp $
 *
...
struct lvmap db_ios_route_map_fmts[] = {
...
struct lvmap db_ios_fmts[] = {
...
#else
    {"system.login.user[]", "", NULL, LVPRINT_MODE, db_ios_user_fmts},
#endif
    ...
    {"interface[].unit[]", "interface $name", NULL, LVPRINT_MODE, db_ios_if_fmts},

    {"#", "!", "!", LVPRINT_COMMENT},
    {"router.router-id", "router-id $routerid", NULL, LVPRINT_CMD},
    {"#", "!", "!", LVPRINT_COMMENT},
    {"router.rip", "router rip", NULL, LVPRINT_MODE, db_ios_rip_fmts},
    {"#", "!", "!", LVPRINT_COMMENT},
    {"router.ospf", "router ospf", NULL, LVPRINT_MODE, db_ios_ospf_fmts},
    {"#", "!", "!", LVPRINT_COMMENT},
    {"router.bgp", "router bgp $as", NULL, LVPRINT_MODE, db_ios_bgp_fmts},
    {"#", "!", "!", LVPRINT_COMMENT},
    ...
    {"#", "!", "!", LVPRINT_COMMENT},
    {"route-map[].line[]", "route-map $name $action $line", NULL, LVPRINT_MODE, db_ios_route_map_fmts},
    {"#", "!", "!", LVPRINT_COMMENT},
